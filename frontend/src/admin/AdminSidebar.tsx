...
import { LayoutDashboard, Package, FolderOpen, ChevronLeft, ChevronRight, Pizza, Receipt, UserCircle, MessageSquare } from "lucide-react";
...
const navItems = [
    ...
    { to: "/admin/notifications", label: "Messages", icon: MessageSquare },
